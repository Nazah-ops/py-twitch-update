...
class VideoEditor:
    ...
    def concatenate_fade_video(self, clips: [str], transition_time):
        path_to_file = os.environ.get(
            "BASE_PATH") + "/files/clips/final_output.mp4"
        ...
        final.write_videofile(os.environ.get(
            "BASE_PATH") + "/files/clips/final_output.mp4")
        return path_to_file
