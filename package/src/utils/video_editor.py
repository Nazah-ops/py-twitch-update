...
class VideoEditor:
    ...
    def merge_audio_with_video(self, video: str, audio: str) -> str:
        target_dir = work_dir(f"{uuid4()}.mp4")

        # Aggiungi l'audio nuovo
        output_videoclip = VideoFileClip(video)
    ...
    def mute_audio(self, video: str) -> str:
        ...
        return videoclip_without_audio
